...
do
	...
	fastp -i $workingdir/GlenRaw/${i}_1.fastq.gz -I $workingdir/GlenRaw/${i}_2.fastq.gz -o $workingdir/GlenTrimmed/${i}_fp1.fastq.gz -O $workingdir/GlenTrimmed/${i}_fp2.fastq.gz --detect_adapter_for_pe --trim_poly_g --correction
